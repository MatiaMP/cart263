...
/***CODE */ document.querySelector("p").textContent = "New text in paragraph one: text changed by Matia on the following date: '1/20/2026'."
/*************************************** */
/* 2: Select all elements in the HTML that have the class name content-container
 and change the background color ... of first and second ...*/
/***CODE */ document.getElementsByClassName("content-container")[0].style.backgroundColor = "orange";
...
/* 1B: Create a function:function 
customCreateElement(parent){ //body } */
...
/***EXPLANATION::
 * 
 * First we access all paragraph elements, and store the result in a variable called: allPTagsThree. To do this we use querySelectorAll("p"), to select all paragraphs.
 * 
 * customCreateElement then creates a new paragraph element and we customized it in the following steps and appended as a child.
 * 
 * this then makes it so that the new paragraph is put under every paragrah element already yexisting.
 * 
 * 
 */
